...
const fullText =
  ...
  <span style="color:#c0392b; font-weight:600;">심층 분석과 인사이트</span>는  
  <span style="background: linear-gradient(90deg, #ff8a00, #e52e71); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight:700;">
    무료 뉴스레터
  </span>에서 확인하세요.`;
